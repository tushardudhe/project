        ...
        <table class="table table-hover table-striped">
            <tr>
                <td colspan="6">
                    ...
                    <a href="delete-all.php" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?');">Delete All</a>
            ...
            <tbody>
                <?php
                $sql = mysqli_query($al, "SELECT * FROM data ORDER BY id DESC");
                $x = 1;
